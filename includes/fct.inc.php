...
{
    //isset c interroger si c vrai ou faux 
    //cette fonction demande si dans notre superglobale Session est ce que ya un id 
...
/**
 * retourne si le statut visiteur si il est connecté
 * @return type
 */
function estVisteurConnecte()
{  
    if (estConnecte()){
