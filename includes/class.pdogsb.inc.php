...
class PdoGsb
{
    ...
    // elle regarde si on est connecte a la bdd PdoGsb, sinon on se sera direct connecte grace l'instanciation de la classe PdoGsb (new PdoGsb)
    {
 ...
 /**
    ...
    public function getLesVisiteurs(){
      ...
      //cloture les fiches frais du mois précedent
    ...
    /**
     * Retourne la liste de tous  les  visiteur
   
     *
     * la liste de tous  les  visiteur  sous la forme d'un tableau associatif
     */
    public function getLesVisiteurs()
    {
        $requetePrepare = PdoGsb::$monPdo->prepare(
